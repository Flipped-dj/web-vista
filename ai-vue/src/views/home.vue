            ...
            <div class="text">
                <div>
                    ...
                    <div class="hero-actions">
                        <el-button size="large" @click="goToConsultation">开始倾诉，获得陪伴</el-button>
                        <el-button size="large" style="border-color: #fff" color="transparent" @click="goToKnowledge">记录心情,释放情感</el-button>
                    </div>
                </div>
            </div>
            <div class="robot">
